...
func isCreateMode(projects, addFlagSet, setTaskFlagSet, repos, status bool, depPath string, allDeps, list, done, mergeBack bool) bool {
	if projects || addFlagSet || setTaskFlagSet || repos || status {
		return false
	}
